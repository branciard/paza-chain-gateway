...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "pazachaingateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "pazachaingateway API";

        private String description = "pazachaingateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "pazachaingateway";
