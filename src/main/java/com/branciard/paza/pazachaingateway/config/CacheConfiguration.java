...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        config.setInstanceName("pazachaingateway");
        ...
        config.getMapConfigs().put("com.branciard.paza.pazachaingateway.domain.*", initializeDomainMapConfig(jHipsterProperties));
