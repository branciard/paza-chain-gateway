...
@EnableZuulProxy
public class PazachaingatewayApp {

    private static final Logger log = LoggerFactory.getLogger(PazachaingatewayApp.class);

    @Inject
    private Environment env;

    /**
     * Initializes pazachaingateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PazachaingatewayApp.class);
